...
let favoriteBook = Book(title: "Mosaic", author: "John R. Maxim", pages: 448, price: 5.15)
...
// Declare two instances using memberwise initializers:
let firstLaptop = Laptop(yearPurchased: 2020)
let secondLaptop = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2021)

print("First Laptop - Screen Size: \(firstLaptop.screenSize), Repair Count: \(firstLaptop.repairCount), Year Purchased: \(firstLaptop.yearPurchased)")
print("Second Laptop - Screen Size: \(secondLaptop.screenSize), Repair Count: \(secondLaptop.repairCount), Year Purchased: \(secondLaptop.yearPurchased)")
...
// Create a variable instance of `Height` called `someonesHeight`
...
assert(someonesHeight.heightInCentimeters == 165.1, "The height in centimeters should be 165.1")
...
// Create a variable instance of `Height` called `myHeight`
