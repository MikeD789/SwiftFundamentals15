...
var myUser = User(name: "Michael", age: 35, height: 170.0, weight: 90.0, activityLevel: 8)

print("Name: \(myUser.name)")
print("Age: \(myUser.age)")
print("Height: \(myUser.height) cm")
print("Weight: \(myUser.weight) kg")
print("Activity Level: \(myUser.activityLevel)/10")
...
let anotherDistance = Distance(feet: 5280)
