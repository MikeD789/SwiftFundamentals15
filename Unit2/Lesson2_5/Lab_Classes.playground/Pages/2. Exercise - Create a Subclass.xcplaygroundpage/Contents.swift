...
// This won't work because `falcon` is an instance of `Spaceship`, which does not have a `weapon` property.
//print(falcon.weapon) // Uncommenting this line will cause a compilation error
print("The `falcon` instance is a `Spaceship`, and it does not have a `weapon` property.")
...
// Create a new instance of `Fighter` called `destroyer` again to include the new method
let destroyer = Fighter()
destroyer.name = "Destroyer"
destroyer.weapon = "Laser"
destroyer.remainingFirePower = 10
