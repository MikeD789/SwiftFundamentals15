...
print("Days in month dictionary: \(daysInMonth)")


//:  Using subscripting syntax to add April to the collection with a value of 30. Print the dictionary.
daysInMonth["April"] = 30
print("Days in month dictionary after adding April: \(daysInMonth)")


//:  It's a leap year! Update the number of days in February to 29 using the `updateValue(_:, forKey:)` method. Print the dictionary.
daysInMonth.updateValue(29, forKey: "February")
print("Days in month dictionary after updating February: \(daysInMonth)")
...
let categoryDictionary: [String: [String]] = ["Shapes": shapesArray, "Colors": colorsArray]
print("Category dictionary: \(categoryDictionary)")
...
if let colors = categoryDictionary["Colors"] {
    print("The last color in the array is \(colors.last!)")
}
