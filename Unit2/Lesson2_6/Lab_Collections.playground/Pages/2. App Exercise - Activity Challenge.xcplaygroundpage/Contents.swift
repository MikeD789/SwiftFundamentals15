 ...
 */
let walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 10,000 steps a day"]
let runningChallenges: [String] = ["Run 5 times a week", "Run a 5k race"]
...
print("Challenges after removeAll: \(mutableChallenges)")
