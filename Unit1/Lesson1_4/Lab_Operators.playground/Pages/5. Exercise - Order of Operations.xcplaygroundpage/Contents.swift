...
// Print out what you think 4 * 9 - 6 / 2 evaluates to
print("I think 4 * 9 - 6 / 2 evaluates to 30")
...
// Print the result of 4 * 9 - 6 / 2 with subtraction prioritized over multiplication and division
print(4 * (9 - 6) / 2)
