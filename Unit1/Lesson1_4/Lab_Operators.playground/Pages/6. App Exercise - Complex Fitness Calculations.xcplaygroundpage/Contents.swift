 ...
 */
// Create three separate heart rate constants of type Double
let heartRate1: Double = 72
let heartRate2: Double = 85
let heartRate3: Double = 90

// Calculate the average heart rate in one line using proper order of operations
let averageHeartRate = (heartRate1 + heartRate2 + heartRate3) / 3

// Print the result
print("The average heart rate is \(averageHeartRate) beats per minute.")
...
// Create a constant for body temperature in Fahrenheit
let tempInFahrenheit = 98.6

// Print the result
print("The current body temperature is \(tempInFahrenheit)°F.")
