 ...
 */
// Create three constants for heart rates
let heartRate1 = 72
let heartRate2 = 85
let heartRate3 = 90

// Calculate the sum of all three heart rates
...
// Create three constants for heart rates as Double values
...
// Print the result
print("The average heart rate over the last hour is \(averageHRD) beats per minute.")
...
// Create constants for steps and goal as Double values
let steps: Double = 3467
let goal: Double = 10000

// Calculate the percent of the goal achieved
