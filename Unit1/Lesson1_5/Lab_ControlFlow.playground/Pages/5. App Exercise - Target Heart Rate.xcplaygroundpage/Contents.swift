...
// Given target heart rate bounds and current heart rate
let targetLowerBound = 120
let targetUpperBound = 150
let currentHR = 147

// Create constants to evaluate heart rate zones
...
// Write an if-else-if statement to provide feedback based on heart rate zones
if isInTarget {
