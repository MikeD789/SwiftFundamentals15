 ...
 */
// Create a variable for the number of steps taken today
var steps = 4500 // You can adjust this value to your guess

// Create a constant for the step goal
let stepGoal = 10000

// Write an if-else statement to provide encouragement based on the number of steps
if steps < stepGoal / 2 {
...
// Write an if-else-if statement to provide encouragement based on the number of steps
