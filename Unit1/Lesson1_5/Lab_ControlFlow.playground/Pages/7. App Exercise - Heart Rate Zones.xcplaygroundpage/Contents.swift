...
// Write a switch statement to print different statements based on the heart rate range
switch currentHR {
case 100...120:
...
default:
    print("Warning: Your heart rate is above the safe range. Please slow down.")
