 ...
 */
var dollars = 0
// Declare a variable with an initial value of 0
var dollars = 0

// Write an if statement to check if dollars is 0
if dollars == 0 {
...
// Write an if-else statement to check the value of dollars
if dollars == 0 {
    print("Sorry, kid. You're broke!")
} else {
...
dollars = 105
// Declare a variable with an initial value of 105
var dollars = 105

// Write an if-else-if statement to check the value of dollars
if dollars == 0 {
    print("Sorry, kid. You're broke!")
} else if dollars < 100 {
    print("You've got some spending money!")
