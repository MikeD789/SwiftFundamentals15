...
print("The above code does not compile because friends was declared with the let keyword which makes it a constant and Swift language will not allow change once constants given or assigned a value")
